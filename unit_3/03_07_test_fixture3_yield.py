# Для явного закрытия браузера после каждого теста мы можем воспользоваться финализаторами.
...
# Лучше выносить очистку данных и памяти в фикстуру, вместо того чтобы писать это в шагах теста:
